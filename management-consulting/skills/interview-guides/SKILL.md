...
description: Design, conduct, and synthesize stakeholder interviews for consulting engagements — question design, interview protocols, note-taking, cross-interview synthesis, and insight generation. Use whenever stakeholder interviews, interview guides, question banks, interview synthesis, qualitative research, or discovery interviews come up.
---
...
1. **Broad entry:** "Walk me through how an order gets approved in your area."
   - Respondent provides overview
2. **Specific funnel:** "You mentioned it takes 2-3 days. Why does it take that long?"
   - Narrow to timeline and root causes
3. **Deeper probe:** "When you say you're waiting for finance, who specifically do you wait for? What are they checking?"
   - Narrow to specific bottleneck
4. **Detail:** "If you had to describe the ideal approval process, what would it look like?"
...
1. **Clean up notes** (if handwritten, type up)
2. **Fill in middle column:** Your interpretations and questions
3. **Add summary box** at bottom:
