...
- [`references/whitepaper-thought-leadership-reference.md`](references/whitepaper-thought-leadership-reference.md) — Complete framework details, templates, and examples
