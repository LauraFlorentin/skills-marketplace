...
3. **Step 3**: Generate PMI Target Operating Model — feed synergy data into workstream plans:
   ...
   - Duplicate vendors → IT/Procurement termination schedule
   - Facility overlaps → Real estate lease break timeline

Review and validate at each transition point before proceeding.

Ask the user for: target and acquirer organizational data, signed purchase agreement terms, and any prior synergy estimates.
