---
description: Draft an Indication of Interest (IOI) letter — a non-binding expression of intent to acquire with valuation range and structure
---
...
Ask the user for: the target CIM or key details, the buyer's investment thesis, approved valuation range, and any structural preferences (rollover, earn-outs, etc.).
