---
name: initiation
description: Project charters, stakeholder mapping, and kickoff planning for software and general PMs Use when user asks to "create a project charter", "map stakeholders", "kick off a project", or mentions project setup, stakeholder analysis, or kickoff meeting.
triggers:
  - project charter
  - stakeholder map
...
- [`references/initiation-reference.md`](references/initiation-reference.md) — Complete framework details, templates, and examples
